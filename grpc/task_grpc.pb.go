...
type TaskServiceClient interface {
	...
	SubmitTask(ctx context.Context, in *TaskResult, opts ...grpc.CallOption) (*ResultAck, error)
}
...
func (c *taskServiceClient) GetTask(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TaskResponse, error) {
...
func (c *taskServiceClient) SubmitTask(ctx context.Context, in *TaskResult, opts ...grpc.CallOption) (*ResultAck, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResultAck)
...
type TaskServiceServer interface {
	...
	SubmitTask(context.Context, *TaskResult) (*ResultAck, error)
...
func (UnimplementedTaskServiceServer) GetTask(context.Context, *emptypb.Empty) (*TaskResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTask not implemented")
}
func (UnimplementedTaskServiceServer) SubmitTask(context.Context, *TaskResult) (*ResultAck, error) {
...
func _TaskService_SubmitTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).SubmitTask(ctx, req.(*TaskResult))
	}
	return interceptor(ctx, in, info, handler)
}
